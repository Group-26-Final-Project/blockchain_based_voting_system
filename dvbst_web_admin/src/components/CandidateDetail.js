...
export default function CandidateDetail() {
  ...
  const getProfileUrl = () => {
    if (candidateDetail.zcandidate) {
      console.log("am here in first");
      console.log(
        "candidateDetail.zcandidate.id",
        candidateDetail.zcandidate.candidateInfo.studentId
      );
      const id = candidateDetail.zcandidate.candidateInfo.studentId.replaceAll(
        "/",
        "_"
      );
      console.log("id", id);
      console.log(
        "ppurl: ",
        candidateDetail.zcandidate.candidateProfilePicture
      );
      if (id === candidateDetail.zcandidate.candidateInfo.studentId)
        return "https://randomuser.me/api/portraits/women/81.jpg";

      if (candidateDetail.zcandidate.candidateProfilePicture.includes(id)) {
        console.log("am here in second");
        return `${process.env.REACT_APP_MORALIS_SERVER_URL}/files/${process.env.REACT_APP_MORALIS_APPID}/${candidateDetail.zcandidate.candidateProfilePicture}`;
      }
    }
    return "https://randomuser.me/api/portraits/women/81.jpg";
  };
          ...
          <div class="flex flex-col justify-center items-center py-8 px-8 lg:px-16">
            ...
            <div>
              <h2 class="my-4 text-xl font-bold text-gray-900">
                {candidateDetail.zcandidate.candidateInfo.fullName}
              </h2>
            </div>
            ...
            <div class="w-[50vw] py-2 px-4 lg:px-8">
              <div class="flex flex-row justify-between items-center mb-6 md:mb-1">
                ...
                <input
                  ...
                  type="text"
                  value={
                    candidateDetail.zcandidate.candidateInfo.fullName.split(
                      " "
                    )[0]
                  }
                />
              ...
              <div class="flex flex-row justify-between items-center">
                ...
                <input
                  ...
                  name="id"
                  type="text"
                  value={candidateDetail.zcandidate.candidateInfo.studentId}
                />
              </div>
              <div class="flex flex-row justify-between items-center">
                <label
                ...
                <input
                  ...
                  name="email"
                  type="text"
                  value={candidateDetail.zcandidate.candidateInfo.email}
                />
              </div>
              <div class="flex flex-row justify-between items-center">
                <label
                ...
                <input
                  ...
                  name="phone"
                  type="text"
                  value={candidateDetail.zcandidate.candidateInfo.phone}
                />
              </div>
              <div class="flex flex-row justify-between items-center mb-6 md:mb-1">
                <label
                ...
                <input
                  ...
                  name="dept"
                  type="text"
                  value={deptTypes[candidateDetail.zcandidate.candidateInfo.currentDepartment]}
                />
              </div>
              <div class="flex flex-row justify-between items-center mb-6 md:mb-1">
                <label
                ...
                <input
                  ...
                  name="year"
                  type="text"
                  value={candidateDetail.zcandidate.candidateInfo.currentYear}
                />
              </div>
              <div class="flex flex-row justify-between items-center">
                <label
                ...
                <input
                  ...
                  type="text"
                  value={
                    candidateDetail.zcandidate.candidateInfo.currentSection
                  }
                />
              </div>
            </div>
