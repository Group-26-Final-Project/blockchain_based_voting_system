...
export default function NewCandidate() {
  ...
  const {
    ...
    params: {
      ...
      profilePicture: "ma profile pic bruv",
      bio: formValues.bio,
      role: 1,
    },
  });
  ...
  useEffect(() => {
    ...
    // const checkIfWeb3Enabled = async () => {
    ...
    // };
    // checkIfWeb3Enabled();
  }, [formErrors, isSubmit, isInitialized, isWeb3Enabled, Moralis]);
    ...
    <div class="min-h-screen w-full bg-white-800 flex flex-row align-center content-center py-8 px-4 lg:px-8">
      ...
      {addNewCandidateData && (
        <div>
          ...
          <h2>{addNewCandidateData.toString()}</h2>
        </div>
      )}
